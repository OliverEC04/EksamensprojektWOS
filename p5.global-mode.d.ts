...
declare function textAlign(a:string): any;
declare function ellipse(a:number,b:number,c:number): any;
declare function text(a:string, b:number, c:number): any;
declare var CENTER: any;
declare function setup():any;
declare function resizeCanvas(a:number, b:number):any;
 ...
 */
declare function blue(obj: any): number;
 ...
 */
declare function red(obj: any): number;
